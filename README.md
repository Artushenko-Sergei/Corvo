...
Программа бесплатная и с открытым исходным кодом, и такой останется. Если она вам
полезна — [конверт Privat24](https://www.privat24.ua/send/450nd). Деньги идут на время разработки, тестирование
на разных дистрибутивах и публикацию в Flathub.
